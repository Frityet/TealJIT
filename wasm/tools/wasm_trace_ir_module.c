...
int main(void)
{
  ...
  setir(&T, REF_FIRST+9, IR_LOOP, IRT_NIL, 0, 0);
  setir(&T, REF_FIRST+10, IR_PHI, IRT_INT, REF_FIRST+0, REF_FIRST+1);
  setir(&T, REF_FIRST+11, IR_PHI, IRT_NUM, REF_FIRST+5, REF_FIRST+6);
