/*
** Emit the IR shape for a descending numeric Lua for-loop as a WASM64 trace
...
int main(void)
{
  enum { NIR = 13, K1 = REF_BASE-5, KM1 = REF_BASE-4 };
  ...
  setir(&T, REF_FIRST+4, IR_ADD, IRT_INT, REF_FIRST+0, KM1);
  setguard(&T, REF_FIRST+5, IR_GE, IRT_INT, REF_FIRST+4, K1);
  ...
  setir(&T, REF_FIRST+9, IR_ADD, IRT_INT, REF_FIRST+4, KM1);
  setguard(&T, REF_FIRST+10, IR_GE, IRT_INT, REF_FIRST+9, K1);
